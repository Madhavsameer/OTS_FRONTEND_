...
const ListNotes = () => {
  ...
  const fetchNotes = async () => {
    try {
      const response = await axios.get('https://otsbackend.netlify.app/api/assignment/all');
  ...
  const openNoteAsPdf = async (noteId) => {
    try {
      const response = await axios.get(`https://otsbackend.netlify.app/api/assignment/${noteId}`, {
