...
export default function FindUser() {
  ...
  const onSubmit = async (e) => {
    e.preventDefault();
    try {
      await axios.post(`https://otsbackend.netlify.app/loginuser`, user);
  ...
  const onSubmita = async (e) => {
    e.preventDefault();
    try {
      await axios.post(`https://otsbackend.netlify.app/loginprofessor`, user);
  ...
  const onSubmitb = async (e) => {
    e.preventDefault();
    try {
      await axios.post(`https://otsbackend.netlify.app/loginadmin`, user);
      navigate("/Home");
    } catch {
      let a = document.getElementById("er");
